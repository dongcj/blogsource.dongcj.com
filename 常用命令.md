...
## 映射samba至Linux
```
# 注意：一定要有mount.cifs才可以，如Ubuntu需要安装
apt-get install smbfs
mount [-t cifs]  -o username=root,password=passw0rd //192.168.88.181/public /mnt
```
> smbstatus可以查看目前有哪些连接


## Mount webdav
```
# 安装fuse, davfs2, neon-devel
...
## 使用以下命令可以更新网域内的arp
    arping -U 10.85.138.111 -A -I br0 -c 1（需要10.85.138.111这个IP在本机上）
